              ...
              workouts.map((item) => (
                <div class="col-workout">
                  <div class="card-workout h-auto bg-dark">
                    ...
                    >
                      <img
                        src={`data:image/${item.img.img0.contentType};base64, ${Buffer.from(item.img.img0.data).toString('base64')}`}
                        class="card-img-top"
                        alt="p5"
                        id="p5"
                      />
                              ...
                              <div class="workout-effects">
                                <div class="workout-effects-container">
                                  <div class="workout-effect-1">
                                    ...
                                    <img
                                      src={`data:image/${item.img.img1.contentType};base64, ${Buffer.from(item.img.img1.data).toString('base64')}`}
                                  ...
                                  <div class="workout-effect-234">
                                    <img
                                      src={`data:image/${item.img.img2.contentType};base64, ${Buffer.from(item.img.img2.data).toString('base64')}`}
                                      alt="workout1.2"
                                      id="workout-effects-2"
                                    />
                                    <img
                                      src={`data:image/${item.img.img3.contentType};base64, ${Buffer.from(item.img.img3.data).toString('base64')}`}
                                      alt="workout1.3"
                                      id="workout-effects-3"
                                    />
                                    <img
                                      src={`data:image/${item.img.img4.contentType};base64, ${Buffer.from(item.img.img4.data).toString('base64')}`}
                                      alt="workout1.4"
